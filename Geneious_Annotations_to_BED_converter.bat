...
Rscript \\mhsdata.anu.edu.au\mhs\workgroups\jcsmr\ArkellLab\Bio_Informatics\Kyle_R_codes\Geneious_Annotations_to_BED_File_Converter.R %filepath% %chromosome% %track_name% %track_description% %browser_position%
